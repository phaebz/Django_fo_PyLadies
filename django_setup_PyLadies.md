...
####Installing Django
Since django is just a python module, you need to have python installed to use it. If you're on Linux or Mac OS X, you probably have Python already installed. Type ```python``` at a command prompt (or in your terminal, on OS X). If you see something like this, then Python is installed:
<pre>
...
Official django releases have a version number, such as 1.4.2, 1.4.1 or 1.4, and the latest one is always available at <http://www.djangoproject.com/download/>. As of this writing, the official stable version is 1.6. Generally, you should stay with the stable version - unless you want the latest features and bugs (: ... if you feel adventurous and exciting, continue with the next section - otherwise just skip it.
...
or do it in a one liner on the command line
<pre>
...
Now that the server's running, visit <http://127.0.0.1:8000/> with your web browser. You'll see a "Welcome to Django" page. It worked! Now you are ready to dive into the django "polls" tutorial [over here](https://docs.djangoproject.com/en/dev/intro/tutorial01/).
